...
import { Search, Filter, AlertTriangle, MapPin, ArrowRight } from 'lucide-react';
...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 2500,
    unit: "per head",
    image: "https://images.unsplash.com/photo-1484557985045-6f550bb43282?auto=format&fit=crop&q=80&w=600",
  ...
  },
  {
    ...
    price: 18000,
    unit: "per head",
    image: "https://images.unsplash.com/photo-1596733430204-070a92b92539?auto=format&fit=crop&q=80&w=600",
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="bg-yellow-50 border-b border-yellow-100 p-3 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-yellow-800 font-medium">
            ...
            <span>Beta Mode: These listings are currently for demonstration purposes only. Transactions are disabled.</span>
          </div>
        </div>

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <h1 className="text-3xl font-bold text-gray-900">Marketplace</h1>
          <p className="mt-2 text-gray-500">Find direct-from-farm livestock and fresh produce.</p>
                ...
                <div className="p-5">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <Link to="#" className="text-sm text-green-600 hover:text-green-700 font-medium hover:underline">
                        @{product.farmName}
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <button 
                      onClick={() => alert("This is a demo listing. Transactions are currently disabled.")}
